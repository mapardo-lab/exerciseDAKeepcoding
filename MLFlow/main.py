...
def main(): 
    ...
    group.add_argument("--rawdata", help="Path raw data file")
    group.add_argument("--procdata", help="Path to processed data file")

    args = parser.parse_args()

    if args.rawdata:
        # read raw data
        raw_data = read_raw_data(args.rawdata)
        print('Reading data ...')
        ...
        words_train, words_test, labels_train, labels_test = read_proc_data(args.procdata)
